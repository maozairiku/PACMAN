...
// マクロ定義
//*****************************************************************************
#define	MODEL_PLAYER			"data/MODEL/eatman.obj"			// 読み込むモデル名
#define	MODEL_PLAYER_LPARTS		"data/MODEL/leftwing.obj"		// 読み込むモデル名
#define	MODEL_PLAYER_RPARTS		"data/MODEL/rightwing.obj"		// 読み込むモデル名
...
static INTERPOLATION_DATA move_tbl[] = {	// pos, rot, scl, frame
	{ XMFLOAT3(20.0f, 10.0f, 0.0f), XMFLOAT3(0.0f, 0.0f, 0.0f),      XMFLOAT3(5.0f, 5.0f, 5.0f), 120 },
	{ XMFLOAT3(20.0f, 10.0f, 0.0f), XMFLOAT3(XM_PI/2, 0.0f, 0.0f),   XMFLOAT3(5.0f, 5.0f, 5.0f), 240 },
	{ XMFLOAT3(20.0f, 10.0f, 0.0f), XMFLOAT3(0.0f, 0.0f, 0.0f),      XMFLOAT3(5.0f, 5.0f, 5.0f), 120 },
	{ XMFLOAT3(20.0f, 10.0f, 0.0f), XMFLOAT3(0.0f, 0.0f, 0.0f),	     XMFLOAT3(5.0f, 5.0f, 5.0f), 120 },
...
static INTERPOLATION_DATA walk_tbl[] = {	// pos, rot, scl, frame
	{ XMFLOAT3(0.0f, 10.0f, 0.0f), XMFLOAT3(0.0f, 0.0f, 0.0f),       XMFLOAT3(5.0f, 5.0f, 5.0f), 120 },
	{ XMFLOAT3(0.0f, 10.0f, 0.0f), XMFLOAT3(0.0f, -XM_PI / 2, 0.0f), XMFLOAT3(5.0f, 5.0f, 5.0f), 240 },
	{ XMFLOAT3(0.0f, 10.0f, 0.0f), XMFLOAT3(0.0f, XM_PI / 2, 0.0f),  XMFLOAT3(5.0f, 5.0f, 5.0f), 120 },
	{ XMFLOAT3(0.0f, 10.0f, 0.0f), XMFLOAT3(0.0f, 0.0f, 0.0f),	     XMFLOAT3(5.0f, 5.0f, 5.0f), 120 },

};

static INTERPOLATION_DATA walk_tbl2[] = {	// pos, rot, scl, frame
	{ XMFLOAT3(0.0f, 10.0f, 0.0f), XMFLOAT3(0.0f, 0.0f, 0.0f),       XMFLOAT3(5.0f, 5.0f, 5.0f), 120 },
	{ XMFLOAT3(0.0f, 10.0f, 0.0f), XMFLOAT3(0.0f, -XM_PI / 2, 0.0f), XMFLOAT3(5.0f, 5.0f, 5.0f), 240 },
	{ XMFLOAT3(0.0f, 10.0f, 0.0f), XMFLOAT3(0.0f, XM_PI / 2, 0.0f),  XMFLOAT3(5.0f, 5.0f, 5.0f), 120 },
	{ XMFLOAT3(0.0f, 10.0f, 0.0f), XMFLOAT3(0.0f, 0.0f, 0.0f),	     XMFLOAT3(5.0f, 5.0f, 5.0f), 120 },
...
static INTERPOLATION_DATA run_tbl2[] = {	// pos, rot, scl, frame
	{ XMFLOAT3(0.0f, 10.0f, 0.0f), XMFLOAT3(0.0f, 0.0f, 0.0f),       XMFLOAT3(5.0f, 5.0f, 5.0f), 120 },
	{ XMFLOAT3(0.0f, 10.0f, 0.0f), XMFLOAT3(0.0f, -XM_PI / 2, 0.0f), XMFLOAT3(5.0f, 5.0f, 5.0f), 240 },
	{ XMFLOAT3(0.0f, 10.0f, 0.0f), XMFLOAT3(0.0f, XM_PI / 2, 0.0f),  XMFLOAT3(5.0f, 5.0f, 5.0f), 120 },
	{ XMFLOAT3(0.0f, 10.0f, 0.0f), XMFLOAT3(0.0f, 0.0f, 0.0f),	     XMFLOAT3(5.0f, 5.0f, 5.0f), 120 },
...
HRESULT InitPlayer(void)
{
	...
	for (int i = 0; i < PLAYER_PARTS_MAX; i++)
	{
		...
		// パーツの読み込み
		g_Parts[i].load = TRUE;
		LoadModel(MODEL_PLAYER_LPARTS, &g_Parts[i].model);

		g_Parts[i].load = TRUE;
		LoadModel(MODEL_PLAYER_RPARTS, &g_Parts[i].model);
